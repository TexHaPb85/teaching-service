...
create table theory_materials (theory_id varchar(255) not null, complexity_value float, default_complexity_value float, text_of_theoryhtml varchar(9020), title varchar(255), paren_topic_id varchar(255), primary key (theory_id));
