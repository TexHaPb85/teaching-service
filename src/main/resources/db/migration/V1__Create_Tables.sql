...
create table task_materials (task_id varchar(255) not null, answer varchar(255), complexity_value float, question varchar(255), paren_topic_id varchar(255), primary key (task_id));
