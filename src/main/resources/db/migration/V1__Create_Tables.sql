...
create table task_materials (task_id varchar(255) not null, answer varchar(255), complexity_value float, question varchar(255), task_type varchar(255), paren_topic_id varchar(255), primary key (task_id));
create table theory_materials (theory_id varchar(255) not null, complexity_value float, text_of_theoryhtml varchar(1020), title varchar(255), paren_topic_id varchar(255), primary key (theory_id));
